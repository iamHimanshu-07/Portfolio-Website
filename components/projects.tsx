...
const projects = [
  ...
  },
  {
    ...
    description:
      "A comprehensive intelligent transport management platform designed to optimize fleet operations, route planning, and real-time vehicle tracking. Features real-time analytics, driver management, and operational efficiency metrics for smart transportation systems.",
    tags: ["Next.js", "React", "TypeScript", "Node.js", "Cloud Computing"],
    github: "https://github.com/iamHimanshu-07/TransitOps-Smart-Transport-Operations-Platform",
    live: "#",
    image: "/images/transit-ops.png",
  },
  {
